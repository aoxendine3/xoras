...
async function generateStepSummary(evaluation, mode) {
  ...
  const modeLabel = mode === "ADVISORY" ? "\u{1F6E1}\uFE0F Advisory Mode (Non-Blocking)" : "\u26A1 Enforcement Mode (Active Gating)";
...
### \u{1F4CA} Release Confidence Report
