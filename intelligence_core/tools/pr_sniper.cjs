...
class PRSniper {
    ...
    async huntBrokenRepos() {
        ...
        console.log("[HARVEST] Sweeping GitHub API for 100 premium open-source targets...");
        ...
        console.log(`[PR_SNIPER] Trapped ${candidatePool.length} premium open-source framework targets.`);
    ...
    async stageAndAudit(issue) {
        ...
        console.log(`\n[PR_SNIPER] Staging Target: ${repoUrl} -> "${issue.title}"`);
